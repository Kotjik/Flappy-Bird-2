...
<li> Hindernisse werden mit der Zeit nach einer bestimmtem Funktion schneller (K)(M)
<li> Abstand zwischen Hindernissen werden mit der Zeit nach einer bestimmtem Funktion kleiner (K)(M)
